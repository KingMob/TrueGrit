...
----
[net.modulolotus/truegrit "2.4.36"]
----

Add the following to your `deps.edn`:

----
net.modulolotus/truegrit {:mvn/version "2.4.36"}
----
...
I will not personally be adding support for any new features. 

However, if there's something you wish to add or improve, feel free to reach
out. I'm open to contributions, but please talk to me before writing code.

==== Design Non-goals

The r4j cache module is currently unsupported, since many Clojure/Java
caching libraries already exist. However, it could be included, if you
are interested.
